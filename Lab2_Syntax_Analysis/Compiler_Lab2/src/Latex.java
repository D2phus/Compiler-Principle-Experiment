...
public class Latex {
    ...
    private HashMap<String, Integer> symbol = new HashMap<>();
    public String[] readFile() throws IOException {
        /*
        * 按行读取得到strLine数组
        * */
        String[] text = new String[256];
        String path = "D:\\IdeaProjects\\2020Compiler_Principle\\Compiler_Lab2\\src\\result\\code.txt";
        ...
        while((line = bufferedReader.readLine()) != null){
            text[lineIndex] = line;
            System.out.println(text[lineIndex]);
            lineIndex++;
        }
    ...
    public void writeFile() throws IOException {
        //Token结果
        String tokenPath = "D:\\IdeaProjects\\2020Compiler_Principle\\Compiler_Lab2\\src\\result\\token_res.txt";
